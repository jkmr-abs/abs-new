...
function SlideNavigation({ current, total, onPrevious, onNext, previousLabel = 'Previous', nextLabel = 'Next' }) {
  return (
    <div data-component="SlideNavigation" className="mt-6 flex items-center gap-3 lg:mt-8">
