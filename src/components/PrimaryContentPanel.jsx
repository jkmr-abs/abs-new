...
function PrimaryContentPanel({ sectionId, number, sectionLabel, title, titleLines, titleHighlightWordIndexes, description, action }) {
  return (
    <div data-component="PrimaryContentPanel" data-section-id={sectionId} className="relative z-10 max-w-[520px] self-start lg:self-auto">
      ...
      <SectionTitle title={title} titleLines={titleLines} highlightWordIndexes={titleHighlightWordIndexes} />
