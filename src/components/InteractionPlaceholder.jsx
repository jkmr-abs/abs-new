function InteractionPlaceholder({ sectionId, interaction, children }) {
  return (
    <div data-component="InteractionPlaceholder" data-placeholder-for={sectionId} data-interaction-type={interaction?.type || 'placeholder'} className="relative h-full min-h-[295px] overflow-hidden border border-white/[0.12] bg-[radial-gradient(circle_at_50%_48%,rgba(255,103,29,0.14),transparent_27%),linear-gradient(115deg,rgba(32,34,39,0.82),rgba(7,8,11,0.94))] shadow-[0_0_2.8rem_rgba(255,103,29,0.13)] lg:h-[min(64vh,600px)] lg:min-h-[460px]">
