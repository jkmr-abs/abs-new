...
const clientData = sectionData.client;
...
function ClientSupportingBlocks() {
  return (
    <div data-component="ClientSupportingContent" className="mt-8 grid max-w-[520px] gap-4 sm:grid-cols-2 lg:mt-10">
      {clientData.supportingBlocks.map((block, index) => (
        <div data-component="ClientSupportingBlock" className="border-t border-white/10 pt-4" key={block.title}>
